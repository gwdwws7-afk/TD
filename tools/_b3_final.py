# -*- coding: utf-8 -*-
"""Batch-3 final acceptance: L01 anchor pair (rebase) + L13 x3 strategies."""
...
class S:
    def __init__(self):
        self.reconnect()
    def reconnect(self):
        _, self.sid = post({"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"b3fin","version":"1"}}})
    def call(self, name, args, tries=8):
        for attempt in range(tries):
            try:
                res, _ = post({"jsonrpc":"2.0","id":300+attempt,"method":"tools/call","params":{"name":name,"arguments":args}}, self.sid)
...
results = {}
results["L01-A"] = run_terminal(1, "adaptive_network", 42, 300, "L01-A")
results["L01-B"] = run_terminal(1, "adaptive_network", 42, 300, "L01-B")
results["L13-adaptive"] = run_terminal(13, "adaptive_network", 42, 920, "L13-adaptive")
results["L13-focused"] = run_terminal(13, "focused_fire", 42, 920, "L13-focused")
results["L13-control"] = run_terminal(13, "control_lattice", 42, 920, "L13-control")
